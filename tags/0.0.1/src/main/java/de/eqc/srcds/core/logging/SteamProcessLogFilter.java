...
import de.eqc.srcds.core.ServerOutputReader;

/**
 * A logging filter for the {@link ServerOutputReader} class.
 * 
 * @author Holger Cremer
 */
public class SteamProcessLogFilter implements Filter {
	...
	return record.getSourceClassName().equals("de.eqc.srcds.core.ServerOutputReader");
    }
